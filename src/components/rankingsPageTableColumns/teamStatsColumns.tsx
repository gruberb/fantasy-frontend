...
import { Column } from "../common/RankingTable/types";
...
const DatesPopover = ({
  ...
  return (
    <div className="absolute z-50 w-64 p-3 bg-white rounded-lg shadow-lg border border-gray-200 mt-1 -top-20 -left-52">
        ...
        <div className="relative inline-flex">
          <div className="px-3 py-1 rounded-full bg-green-100 text-green-800 font-medium flex items-center">
            ...
            {team.winDates?.length > 0 && (
              <button
                className="ml-1 bg-white rounded-full w-4 h-4 flex items-center justify-center text-xs text-green-800 border border-green-800"
                onClick={(e) => {
                  e.stopPropagation();
                  setOpenTooltip(
        ...
        <div className="relative inline-flex">
          <div className="px-3 py-1 rounded-full bg-blue-100 text-blue-800 font-medium flex items-center">
            ...
            {team.topThreeDates?.length > 0 && (
              <button
                className="ml-1 bg-white rounded-full w-4 h-4 flex items-center justify-center text-xs text-blue-800 border border-blue-800"
                onClick={(e) => {
                  e.stopPropagation();
                  setOpenTooltip(
                    openTooltip?.teamId === team.teamId &&
