        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <DatePicker
              ...
              showYearDropdown
              dropdownMode="select"
              // Configure max/min dates if needed
              // minDate={new Date(new Date().setDate(new Date().getDate() - 30))} // 30 days in the past
              // maxDate={new Date(new Date().setDate(new Date().getDate() + 7))} // 7 days in the future
            />
